...
CUDA_VISIBLE_DEVICES=5 python finetune_virtual.py --input_model_file models_pgcl_sr/all_2.pth --split scaffold --runseed 0 --gnn_type gin --dataset toxcast --lr 1e-3 --epochs 80
