...
for dataset in bace bbbp clintox hiv muv sider
do
...
CUDA_VISIBLE_DEVICES=5 python finetune_virtual.py --input_model_file models_pgcl_sr/new_40.pth --split scaffold --runseed 0 --gnn_type gin --dataset $dataset --lr 1e-3 --epochs 50
done
done
